...
export default function ReportsLoading() {
  ...
  const renderKpiSkeleton = (Icon?: React.ElementType, lines = 1) => (
  ...
  return (
    <div className="container mx-auto p-2 sm:p-4 md:p-6 space-y-4">
      ...
      <div className="grid gap-2 sm:gap-4 grid-cols-2 md:grid-cols-3 xl:grid-cols-7">
        {renderKpiSkeleton(DollarSign, 2)}
        {renderKpiSkeleton(Package)}
        {renderKpiSkeleton(HandCoins)}
        {renderKpiSkeleton(TrendingUp)}
        {renderKpiSkeleton(Repeat)}
        {renderKpiSkeleton(ShoppingCart)}
      </div>
